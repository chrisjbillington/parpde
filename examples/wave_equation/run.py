...
# propagates outward. The bottom third of the spatial region has a slower speed of sound
# by a factor of two, so refraction can be observed.
...
# Note: nx, ny, nx, and ny are for the region of space being simulated in this region
# only, as opposed to the 'global' equivalents which cover the wntire spatial region
...
if __name__ == '__main__':
    ...
    def output_callback(i, t, psi, infodict):
        ...
        output_log_data = np.array(
            (i, t, step_err, time_per_step), dtype=output_log_dtype
        )
